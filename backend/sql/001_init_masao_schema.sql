...
create table if not exists menu_category_translations (
    ...
    constraint ck_menu_category_translations_language check (language_code in ('el', 'en', 'de', 'it', 'sv', 'fr', 'ru', 'he', 'tr'))
);
...
create table if not exists menu_item_translations (
    ...
    constraint ck_menu_item_translations_language check (language_code in ('el', 'en', 'de', 'it', 'sv', 'fr', 'ru', 'he', 'tr'))
);
