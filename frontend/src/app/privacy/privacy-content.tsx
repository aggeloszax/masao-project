...
const COPY: Record<Lang, PrivacyCopy> = {
  el: {
    ...
    sections: [
      ...
      { title: "5. Χρόνος διατήρησης", body: "Οι συνομιλίες διατηρούνται έως 30 ημέρες και στη συνέχεια διαγράφονται. Οι τοπικές επιλογές μενού παραμένουν στη συσκευή σας μέχρι να τις καθαρίσετε ή να διαγράψετε τα δεδομένα του browser." },
  ...
  en: {
    ...
    sections: [
      ...
      { title: "5. Retention", body: "Conversations are retained for up to 30 days and are then deleted. Local menu selections remain on your device until you clear them or delete the browser data." },
  ...
  de: {
    ...
    sections: [
      ...
      { title: "5. Speicherdauer", body: "Unterhaltungen werden bis zu 30 Tage gespeichert und anschließend gelöscht. Lokale Menüauswahlen bleiben bis zur Löschung durch Sie oder der Browserdaten auf Ihrem Gerät." },
  ...
  it: {
    ...
    sections: [
      ...
      { title: "5. Conservazione", body: "Le conversazioni sono conservate fino a 30 giorni e poi eliminate. Le selezioni locali restano sul dispositivo finché non le cancelli o elimini i dati del browser." },
  ...
  sv: {
    ...
    sections: [
      ...
      { title: "5. Lagringstid", body: "Samtal sparas i upp till 30 dagar och raderas sedan. Lokala menyval finns kvar tills du rensar dem eller tar bort webbläsarens data." },
  ...
  fr: {
    ...
    sections: [
      ...
      { title: "5. Conservation", body: "Les conversations sont conservées jusqu’à 30 jours puis supprimées. Les sélections locales restent sur votre appareil jusqu’à leur effacement ou la suppression des données du navigateur." },
  ...
  ru: {
    ...
    sections: [
      ...
      { title: "5. Срок хранения", body: "Беседы хранятся до 30 дней, после чего удаляются. Локальные выбранные позиции остаются на устройстве, пока вы их не очистите или не удалите данные браузера." },
  ...
  he: {
    ...
    sections: [
      ...
      { title: "5. תקופת שמירה", body: "שיחות נשמרות עד 30 יום ולאחר מכן נמחקות. בחירות מקומיות נשארות במכשיר עד שתנקו אותן או תמחקו את נתוני הדפדפן." },
