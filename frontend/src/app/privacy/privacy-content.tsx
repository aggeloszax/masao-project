...
const COPY: Record<Lang, PrivacyCopy> = {
  ...
  en: {
    ...
    sections: [
      ...
      { title: "2. Data we use", body: "The service uses:", items: ["Messages you choose to send to the AI chat.", "Your selected language and a random, pseudonymous device identifier.", "Basic security and request-related technical data."], after: "Your selected dishes and notes are stored locally on your device." },
  ...
  de: {
    ...
    sections: [
      ...
      { title: "2. Verwendete Daten", body: "Der Dienst verwendet:", items: ["Nachrichten, die Sie an den KI-Chat senden.", "Ihre gewählte Sprache und eine zufällige, pseudonyme Gerätekennung.", "Grundlegende Sicherheits- und technische Anfragedaten."], after: "Ihre ausgewählten Gerichte und Notizen werden lokal auf Ihrem Gerät gespeichert." },
  ...
  it: {
    ...
    sections: [
      ...
      { title: "2. Dati utilizzati", body: "Il servizio utilizza:", items: ["I messaggi che scegli di inviare alla chat AI.", "La lingua selezionata e un identificativo casuale e pseudonimo del dispositivo.", "Dati tecnici essenziali di sicurezza e delle richieste."], after: "I piatti selezionati e le note sono memorizzati localmente sul dispositivo." },
  ...
  sv: {
    ...
    sections: [
      ...
      { title: "2. Uppgifter som används", body: "Tjänsten använder:", items: ["Meddelanden du väljer att skicka till AI-chatten.", "Ditt valda språk och en slumpmässig, pseudonym enhetsidentifierare.", "Grundläggande säkerhets- och tekniska förfrågningsuppgifter."], after: "Valda rätter och anteckningar lagras lokalt på din enhet." },
  ...
  fr: {
    ...
    sections: [
      ...
      { title: "2. Données utilisées", body: "Le service utilise :", items: ["Les messages que vous choisissez d’envoyer au chat IA.", "La langue choisie et un identifiant aléatoire et pseudonyme de l’appareil.", "Des données techniques essentielles de sécurité et de requête."], after: "Vos plats sélectionnés et vos notes sont stockés localement sur votre appareil." },
  ...
  ru: {
    ...
    sections: [
      ...
      { title: "2. Используемые данные", body: "Сервис использует:", items: ["Сообщения, которые вы отправляете в ИИ-чат.", "Выбранный язык и случайный псевдонимный идентификатор устройства.", "Основные технические данные безопасности и запросов."], after: "Выбранные блюда и заметки хранятся локально на вашем устройстве." },
  ...
  he: {
    ...
    sections: [
      ...
      { title: "2. מידע בשימוש", body: "השירות משתמש ב:", items: ["הודעות שתבחרו לשלוח לצ'אט ה-AI.", "השפה שנבחרה ומזהה מכשיר אקראי ופסאודונימי.", "נתוני אבטחה ונתונים טכניים בסיסיים של בקשות."], after: "המנות וההערות שבחרתם נשמרות מקומית במכשיר." },
  ...
  tr: {
    ...
    sections: [
      ...
      { title: "2. Kullanılan veriler", body: "Hizmet şunları kullanır:", items: ["Yapay zekâ sohbetine göndermeyi seçtiğiniz mesajlar.", "Seçtiğiniz dil ve rastgele, takma adlı bir cihaz tanımlayıcısı.", "Temel güvenlik ve istek kaynaklı teknik veriler."], after: "Seçtiğiniz yemekler ve notlar cihazınızda yerel olarak saklanır." },
