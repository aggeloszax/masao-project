...
/** Languages offered in the selector. `he` is right-to-left. */
...
export const UI: Record<Lang, UIStrings> = {
  ...
  he: {
    tagline: "טרקלין פיוז'ן אסייתי",
    selectLanguage: "בחירת שפה",
    chatLauncher: "שוחחו עם המלצר",
    chatSubtitle: "המלצר שלך",
    chatGreeting:
      "ברוכים הבאים ל-Masao! ספרו לי מה מתחשק לכם — משהו חריף, עם שרימפס, טבעוני? — ואמליץ על משהו.",
...
export const GROUP_LABELS: Record<string, Record<Lang, string>> = {
  ...
  bites: { el: "Ορεκτικά", en: "Bites", de: "Häppchen", it: "Stuzzichini", sv: "Tilltugg", he: "ביסים" },
  ...
  poke: { el: "Πόκε", en: "Poke", de: "Poke", it: "Poke", sv: "Poke", he: "פוקה" },
...
export const TAG_TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  γλυκόπικρο: { el: "Γλυκόπικρο", en: "Bittersweet", de: "Bittersüß", it: "Dolceamaro", sv: "Bitterljuv", he: "מתוק-מר" },
  ...
  έντονο: { el: "Έντονο", en: "Intense", de: "Intensiv", it: "Intenso", sv: "Intensiv", he: "עז" },
  ...
  μέντα: { el: "Μέντα", en: "Mint", de: "Minze", it: "Menta", sv: "Mynta", he: "מנטה" },
  ...
  νησιώτικο: { el: "Νησιώτικο", en: "Island", de: "Insel", it: "Isolano", sv: "Ö-karaktär", he: "איי" },
  ...
  πικρό: { el: "Πικρό", en: "Bitter", de: "Bitter", it: "Amaro", sv: "Bitter", he: "מר" },
  ...
  signature: { el: "Signature", en: "Signature", de: "Signature", it: "Signature", sv: "Signatur", he: "סיגנון הבית" },
...
> = {
  ...
  he: {
    suggest: (name, price, desc) =>
      `בשמחה! אני ממליץ על ${name} (${price}€) – ${desc}. איך זה נשמע?`,
    also: (list) => ` כדאי לנסות גם: ${list}.`,
    fallback:
      "סליחה, אני לא בטוח מה אתם מחפשים. תעדיפו סושי, נודלס, המבורגרים, קוקטיילים או נרגילה? ספרו לי מה אתם אוהבים ואמליץ על משהו מיוחד!",
  },
};
